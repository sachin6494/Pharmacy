			...
			$(document).ready(function()
	{
		...
		<form name="myform" onsubmit="return validateForm(this);" action="invoice.php" method="post" >
			<table width="200" height="106" border="0" >	
				<tr><td align="left"><input name="customer_id" type="text" style="width:170px" placeholder="Customer ID" id="customer_id" required="required" /></td></tr>
				<tr><td align="left"><input name="customer_name" type="text" style="width:170px" placeholder="Customer Name" id="customer_name" required="required" /></td></tr>
				...
				echo"<select  class=\"input-small\" name=\"drug_name\" style=\"width:170px\" id=\"drug_name\">";
						//  $getpayType=mysql_query("SELECT drug_name FROM stock");
						 $sql = "SELECT drug_name FROM stock";
						 $getpayType = mysqli_query($conn, $sql);
