...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1="SELECT * FROM manager WHERE username='$user'";
...
if(mysqli_query($conn, $sql)) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_manager.php");
}else{
