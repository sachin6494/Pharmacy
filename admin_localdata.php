...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=("SELECT * FROM pharmacist WHERE username='$user'")or die(mysqli_error($con));
...
if(mysqli_query($conn, $sql)) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_pharmacist.php");
}else{
...
?>
	   ...
	   $sql = ("SELECT * FROM pharmacist ")or die(mysqli_error($con));
	   if($selected_val=="All")
	   				$result = ("SELECT * FROM pharmacist")or die(mysqli_error($con));	
	   if($selected_val=="Fullerton")
				   $sql = ("SELECT * FROM pharmacist WHERE postal_address='Fullerton' ")or die(mysqli_error($con));
		if($selected_val=="Michikan")
				   $sql = ("SELECT * FROM pharmacist WHERE postal_address='Michikan' ")or die(mysqli_error($con));
		if($selected_val=="Newark")
				   $sql = ("SELECT * FROM pharmacist WHERE postal_address='Newark' ")or die(mysqli_error($con));
		if($selected_val=="Ladora")
       			$sql = ("SELECT * FROM pharmacist WHERE postal_address='Ladora' ")or die(mysqli_error($con));		   
