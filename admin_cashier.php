...
//  $result=mysql_fetch_array($sql1);
 $sql1 = "SELECT * FROM cashier WHERE username='$user'";
...
if(mysqli_query($conn, $sql)) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_cashier.php");
}else{
